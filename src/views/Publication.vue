  ...
  .publication
    vi-media-object
      ...
      .app-box
        ...
        p Work is a transformative force in our society, and Art is also a powerful force for change – it inspires, and moves people to act.
        p 一段來自國際勞工組織（ILO）網站上的聲明
        p 工作和藝術是人類生於世間的一部分。 從人類第一次收集食物、或為自己建立住所、或將動物皮毛皮制作衣服，工作一直是我們生活中不可或缺的一部分。 自從人類在洞穴壁上的繪畫第一幅畫，我們一直視藝術為一種強有力的表達方法。
    ...
    vi-media-object
      ...
      .app-box
        ...
        p Rhizomising underneath the floating island.  Akin to a mediator or gardener, AOP connects those cramming roots, the islands are therefore enabled to flows, cluster, and elongate by the hauling impact.  Collision compels the islands to various directions to encounter other islands.
        h5 看不見，但存在
        p 檔案工作者曾形容處理文件和檔案的工作經驗如與世隔絕。 島嶼是偏僻的原因之一皆因欠缺接駁的船隻。 人們必須探訪這個看不見的島嶼，以感受其獨特性與存在。 遊客可能需要導遊來帶領瀏覽那未知領域的特徵和景觀，“人人檔案”為您鋪平道路並打開島嶼的入口。
        p 根莖蔓延在浮島下面。人人檔案如園丁或調解員般連接那些縱橫交錯的根，因此島嶼底下的根莖能夠通過衝擊、流動、聚集和伸長來產生碰撞，令孤島向各個方向放射性延伸以連結其他島嶼
</template>
